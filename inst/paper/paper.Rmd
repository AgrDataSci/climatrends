...
The variant B, is calculated using Equation 1, but adjusts $T_{min}$ to $T_{0}$ if $T_{min} < T_{0}$, and is adjusted as follows.

Equation [3]

$$ T_{min} < T_{0} \; \rightarrow \; T_{min} = T_{0} $$
